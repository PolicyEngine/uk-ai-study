...
Figure~\ref{fig:b8} compared decile profiles under two indices; here we
rerun the entire central scenario under five: the C-AIOE (our central
...
be fragile. Our quota mechanism holds the aggregate displacement rate at
...
group is invalid, so occupation had to be imputed. We drew each enhanced
