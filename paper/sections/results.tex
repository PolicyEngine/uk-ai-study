...
Second, the poverty effect all but disappears in the simulated wage-cut cases: the +1.87-point BHC poverty rise becomes +0.03 points under the C-AIOE gradient and +0.07 under PSS. Spreading the calibrated loss across employees pushes fewer households across the frozen absolute line than concentrating losses on displaced workers; this does not establish a bound for other wage schedules.
...
The endpoint comparison conceals a smooth adjustment path. Table~\ref{tab:mixedwage} reports mixtures in which $\lambda$ is the share of the 7 per cent labour adjustment delivered through displacement. Moving from all wage adjustment to all displacement reduces the Exchequer cost from \pounds 22.4 billion to \pounds 18.4 billion, but raises BHC poverty from 0.06 to 1.87 points and the Gini effect from $-0.37$ to $+1.10$ points. The half-and-half case costs \pounds 20.5 billion, raises poverty by 0.92 points and raises the Gini by 0.35 points. The sign of the inequality effect turns positive between $\lambda=.25$ and $.5$; poverty rises approximately in proportion to the share delivered as job loss. The conclusion is therefore not an artefact of comparing two extreme cases: even partial displacement substantially changes the household distribution of a similarly sized labour shock, while the fiscal cost remains in a narrower \pounds 18--22 billion band.
...
Scenario & Displaced & Exchequer cost & $\Delta$ Poverty & $\Delta$ Gini \\
 & (million) & (\pounds bn/yr) & BHC (pp) & (pp) \\
\midrule
\multicolumn{5}{l}{\emph{Share $\lambda$ of 7 per cent adjustment delivered through displacement}} \\
...
\vspace{0.4em}
\parbox{0.92\textwidth}{\footnotesize\emph{Note:} The mixed panel retains the central 2.6 per cent complementarity-graded uplift and allocates the wage-cut component by C-AIOE. The second panel holds the displaced workers and capital shock fixed and changes only the employment-weighted survivor-wage parameter. These are reduced-form comparative statics, not estimates of equilibrium wage responses.}
\end{table}
