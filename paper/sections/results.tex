...
Across the four stylised families, the mean BHC poverty rise lies between 1.75 and 1.93 percentage points and is not reliably ordered across the 20 assignment draws, while mean Exchequer costs span \pounds 7 billion. Uniform incidence has a smaller mean fiscal effect than exposure-proportional incidence without a smaller mean poverty effect. In these runs, a smaller fiscal effect therefore does not imply a smaller poverty effect.
